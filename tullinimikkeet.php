...
if ($tullinimike1 != "") {
  ...
  if (mysqli_num_rows($resul) == 0) {
    ...
    echo sprintf("<font class='message'>Haulla löytyi %s tuotetta.</font><br><br>", mysqli_num_rows($resul));
