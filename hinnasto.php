...
if (isset($submitnappi)) {
  ...
  if (isset($_POST['pp']) and isset($_POST['kk']) and isset($_POST['vv'])) {
    if (mb_strlen(trim($_POST['vv'])) > 0 and mb_strlen(trim($_POST['kk'])) > 0 and mb_strlen(trim($_POST['pp'])) > 0) {
      $pvm = sanitize_string("$_POST[vv]-$_POST[kk]-$_POST[pp]");
  ...
  while ($tuoterow = mysqli_fetch_array($result)) {
