...
if ($tee == 'M') {
  ...
  if ($kohdevarasto == $lahdevarasto) {
    ...
    if ($lahdevarasto != '') {
      ...
      $lahderow = mysqli_fetch_array($result);
    }
    else {
    ...
    if ($kohdevarasto != '') {
      ...
      $result = pupe_query($query);
      $kohderow = mysqli_fetch_array($result);
    }
    else {
  ...
  if ($hyllyalue != '') {
    ...
    if (mysqli_num_rows($result) == 0) {
      ...
      $varastorow = mysqli_fetch_array($result);
      ...
      if ($tuoteno == '') {
        ...
        if (mysqli_num_rows($result) == 1) {
          ...
          if (mysqli_num_rows($result) == 0) {
            ...
            $lahdepaikat = mysqli_fetch_array($result);
          ...
          if ($lahde == 1) {
            ...
            if (mysqli_num_rows($result) == 0) {
              ...
              $kohdepaikat = mysqli_fetch_array($result);
              if ($maara > 0) {
