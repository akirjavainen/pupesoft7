...
while ($maventa_keys = mysqli_fetch_assoc($maventa_result)) {
  ...
  $maventan_kellonaika = date("Y-m-d H:i:s", strtotime(mb_substr($maventan_kellonaika, 0, 8)."T".mb_substr($maventan_kellonaika, 8)));
