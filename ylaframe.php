...
echo "<td style='width: 175px; padding-right: 0;'>
        ...
        <img style='padding-left: 15px;' src='{$palvelin2}pics/logo.png'>
        </a>
      </td>";
...
if ($kukarow['extranet'] == '') {
  ...
  echo "<td class='ylapalkki'><a class='puhdas' target='mainframe' href='{$palvelin2}pikavalinnat.php'><img src='{$palvelin2}pics/facelift/plussa.png'><br>".t("Lisää")."</a></td>";
}
echo "<td style='padding: 0px; text-align: center;'><img src='{$palvelin2}pics/facelift/divider.png'></td>";
