...
function rivit($result, $laji, $yhtio, $summataan, $toim) {
  ...
  while ($row = mysqli_fetch_assoc($result)) {
    ...
    $kustprow = mysqli_fetch_assoc($vresult);
    ...
    $vresult = pupe_query($query);
    $projprow = mysqli_fetch_assoc($vresult);
...
if (mysqli_num_rows($result_ov) > 0) {
...
if (mysqli_num_rows($result_mrt) > 0) {
...
echo t("Myyntisaamisia").": ".mysqli_num_rows($result_ms)." ".t("kappaletta")."<br><br>";
...
echo t("Ostovelkoja").": ".mysqli_num_rows($result_ov)." ".t("kappaletta")."<br><br>";
...
echo t("Tiliotteiden tiliöinnit").": ".mysqli_num_rows($result_mrt)." ".t("tapahtumaa")."<br><br>";
