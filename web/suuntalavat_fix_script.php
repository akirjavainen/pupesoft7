...
while ($suuntalavat_fetch_row = mysqli_fetch_assoc($suuntalavat_fetch_res)) {

  $arr = mb_strpos($suuntalavat_fetch_row['keikkatunnus'], ",") !== FALSE ? explode(",", $suuntalavat_fetch_row['keikkatunnus']) : array($suuntalavat_fetch_row['keikkatunnus']);
