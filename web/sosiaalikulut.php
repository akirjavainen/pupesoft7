...
if (!isset($alkukausi_vv)) {
  ...
  $alkukausi_vv = mb_substr($tilikausirow['tilikausi_alku'], 0, 4);
  $alkukausi_kk = mb_substr($tilikausirow['tilikausi_alku'], 5, 2);
  $alkukausi_pp = mb_substr($tilikausirow['tilikausi_alku'], 8, 2);
}
    ...
    for ($i = 1; $i < 4; $i++) {
      ...
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        if ($row['kustp'] != '') {
          ...
          $tarkenne_row = mysqli_fetch_assoc($result2);
