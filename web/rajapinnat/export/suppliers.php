...
$header .= "Ohjeita Pankille, Maksuaineiston Lisätietue (Ulkomaa);";
...
$header .= "Hyväksyjä 4;";
$header .= "Hyväksyjä 5;";
$header .= "Sallitaanko Hyväksyntäketjun Muutos;";
$header .= "Laskun Tyyppi;";
$header .= "Tavaran Lähetysmaa;";
...
$header .= "Toimittajatyypin Lisäteito;";
$header .= "Pikaperustus;";
$header .= "Ostohintojen Päivitysväli;";
