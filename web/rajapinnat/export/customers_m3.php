...
while ($row = mysqli_fetch_assoc($res)) {
  ...
  // Delivery terms
  // CIF
  $rivi .= mb_substr($row['toimitusehto'], 0, 3).";";
  ...
  // Entry date
  // 20150813
  $rivi .= mb_substr(str_replace("-", "", $row['luontiaika']), 0, 8).";";

  // OKRGTM
  // Entry time
  // 103926
  $rivi .= mb_substr(str_replace(array(" ", "-", ":"), "", $row['luontiaika']), 8, 6).";";

  // OKLMDT
  // Change date
  // 20150813
  $rivi .= mb_substr(str_replace("-", "", $row['muutospvm']), 0, 8).";";
