...
function nimike($limit = '') {
  ...
  while ($tuote = mysqli_fetch_assoc($rest)) {
    ...
    $tuot_toim_row = mysqli_fetch_assoc($tuot_toim_res);
...
function asiakas($limit = '') {
  ...
  while ($asiakas = mysqli_fetch_assoc($rest)) {
    $row++;
...
function toimittaja($limit = '') {
  ...
  while ($toimittaja = mysqli_fetch_assoc($rest)) {
    $row++;
...
function varastotapahtumat($limit = '') {
  ...
  while ($trow = mysqli_fetch_assoc($res)) {
    ...
    switch (mb_strtolower($trow['tapahtumalaji'])) {
      // ostot
    case 'tulo':
    ...
    #Laitetaan myyjatunnus tyhjänä jos ei asiakasmyyjää ole asetettu
...
function myynti($limit = '') {
  ...
  while ($trow = mysqli_fetch_assoc($res)) {
    ...
    switch (mb_strtoupper($trow['tapahtumalaji'])) {
    case 'G':
