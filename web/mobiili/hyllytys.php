...
$toimittaja = mysqli_fetch_assoc(pupe_query($toimittaja_query));
...
// Jos saapuminen on niin tarkistetaan että se on samalle toimittajalle
  ...
  $saapumisen_toimittaja = mysqli_fetch_assoc(pupe_query($saapuminen_query));
...
if ($row['tilausrivitunnus'] != 0) {
  ...
  $tilausrivitunnus_row = mysqli_fetch_assoc($tilausrivitunnus_res);
