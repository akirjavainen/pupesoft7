...
if ($tee == "") {
  ...
  if ($ostoskori != '') {
    ...
    if (mysqli_num_rows($result) > 0 and file_exists("tulosta_tarjous.inc")) {
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    while ($ostoskori = mysqli_fetch_array($result)) {
      ...
      while ($koririvi = mysqli_fetch_array($riviresult)) {
