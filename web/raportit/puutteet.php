...
if ($tee != '') {
  ...
  if (mysqli_num_rows($try_nimi_result) > 0) {
    while ($try_nimi_row = mysqli_fetch_assoc($try_nimi_result)) {
  ...
  while ($row = mysqli_fetch_array($result)) {
    ...
    if ($try != '') {
      ...
      $tulrow = mysqli_fetch_array($tulresult);
      ...
      if (table_exists("yhteensopivuus_tuote")) {
        ...
        $rekrow = mysqli_fetch_array($rekresult);
      ...
      if (mysqli_num_rows($korvaresult) > 0) {
        ...
        $korvarow = mysqli_fetch_array($korvaresult);
        ...
        if (mysqli_num_rows($korva2result) > 0) {
          while ($krow2row = mysqli_fetch_array($korva2result)) {
        ...
        $korvaavat_temp = mb_substr($korvaavat_temp, 0, -2);
