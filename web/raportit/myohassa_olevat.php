...
if (!isset($tee) or ($tee != "NAYTATILAUS" and $tee != 'MUOKKAATILAUS')) {
  ...
  while ($rivi = mysqli_fetch_array($sresult)) {
    $mul_check = '';
    if ($mul_tuoteryhma!="") {
  ...
  while ($rivi = mysqli_fetch_array($vresult)) {
    $mul_check = '';
    if ($mul_kustannuspaikka!="") {
...
if ($tee == "HAE") {
  ...
  while ($tulrow = mysqli_fetch_array($result)) {
    ...
    if (isset($kayta_ostotilausta) and $kayta_ostotilausta != '') {
      ...
      while ($ostotilausrow = mysqli_fetch_assoc($ostotilausres)) {
      ...
      while ($myohastyneet_row = mysqli_fetch_assoc($myohastyneet_res)) {
