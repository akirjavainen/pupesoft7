...
if ($tee == "raportti") {
  ...
  if ($laji == "myynti" or $laji == "osto" or $laji == "tosite") {
    ...
    if (mysqli_num_rows($result) > 0) {
      ...
      while ($alv_row = mysqli_fetch_assoc($alv_result)) {
      ...
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        if ($laji == "myynti") {
          ...
          $alvrow = mysqli_fetch_assoc($alvres);
        }
        else {
        ...
        if ($laji == "myynti") {
          if ($alvit_logistiikka != 0 and mb_strtoupper($row['maa']) != mb_strtoupper($yhtiorow['maa'])) {
