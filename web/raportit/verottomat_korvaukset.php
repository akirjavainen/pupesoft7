  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
      ...
      while ($erow = mysqli_fetch_assoc($eres)) {
        ...
        if ($row['kuvaus'] == "50" and mb_strtoupper($erow['vienti']) == "FI" and (mb_substr($erow['tuoteno'], 0, 3) == "PPR" or $erow['var'] == "2" or $erow['var'] == "4")) {
          $vspserie[$row["ytunnus"]]["kotimaanpuolipaivat"] = 1;
        }
        elseif ($row['kuvaus'] == "50" and mb_strtoupper($erow['vienti']) == "FI") {
