...
if ($selkuka != '') {
  ...
  $selkukarow = mysqli_fetch_array($result);
}
...
while ($kurow=mysqli_fetch_array($kukares)) {
...
while ($orow=mysqli_fetch_array($result)) {
  ...
  if ($selkukarow["kuka"] != "") {
    ...
    if (mysqli_num_rows($or) != 0) {
      ...
      $oikeurow=mysqli_fetch_array($or);
  ...
  echo "  ".t("$orow[nimitys]")."</td>
      <td align='center'><input type='checkbox' class='A".mb_str_pad($lask, 6, 0, STR_PAD_LEFT)." shift' $checked value='$orow[nimi]#$orow[alanimi]#$orow[sovellus]' name='valittu[]'></td>
      <td align='center'><input type='checkbox' class='B".mb_str_pad($lask, 6, 0, STR_PAD_LEFT)." shift' $paivit  value='$orow[nimi]#$orow[alanimi]#$orow[sovellus]' name='paivitys[]'></td>
      <td align='center'><input type='checkbox' class='C".mb_str_pad($lask, 6, 0, STR_PAD_LEFT)." shift' $luk      value='$orow[nimi]#$orow[alanimi]#$orow[sovellus]' name='lukot[]'></td>
      </tr>";
