...
if ($tee == "PAIVITA" and (checkdate(mb_substr($paivamaara, 5, 2), mb_substr($paivamaara, 8, 2), mb_substr($paivamaara, 0, 4)) or $sarjanumero != "")) {
  ...
  while ($korjaarow = mysqli_fetch_array($korjaaresult)) {
