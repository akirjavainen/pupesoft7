...
function viikonpaivat($kausi) {
  ...
  $viikko = mb_substr($kausi, 4, 2);
  $vuosi  = mb_substr($kausi, 0, 4);
...
if ($tee == '') {
  ...
  $edviikko = mb_substr($kausi, 4, 2)-1;
  $edvuosi  = mb_substr($kausi, 0, 4);
  ...
  $seviikko = mb_substr($kausi, 4, 2)+1;
  $sevuosi  = mb_substr($kausi, 0, 4);
