...
$thyllyalue = mb_strtoupper(pupesoft_cleanstring($ahyllyalue));   // Tuleva tuotepaikka
$thyllynro  = mb_strtoupper(pupesoft_cleanstring($ahyllynro));     // Tuleva tuotepaikka
$thyllyvali = mb_strtoupper(pupesoft_cleanstring($ahyllyvali));   // Tuleva tuotepaikka
$thyllytaso = mb_strtoupper(pupesoft_cleanstring($ahyllytaso));   // Tuleva tuotepaikka
...
if ($tee == "W") {
  ...
  if ($varastopaikka != "") {
    ...
    if (mb_strtoupper($varastopaikka) == mb_strtoupper($minnesiirretaan)) {
...
if ($tee == "V") {
  ...
  while ($rivi = mysqli_fetch_assoc($result)) {
    ...
    $nimitys_result = mysqli_fetch_assoc($nimitys_result);
    ...
    if ($rivi['tyyppi'] == 'S') {
      ...
      $lava_result = mysqli_fetch_assoc($lava_result);
