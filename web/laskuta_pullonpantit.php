...
while ($row = mysqli_fetch_assoc($result)) {
  ...
  $tuoterow = mysqli_fetch_assoc($subresult);
...
foreach ($asiakas_lasku as $item => $laskutunnus) {
  ...
  $laskurow = mysqli_fetch_assoc($hyvitystilaukset);
