...
if (mysqli_num_rows($result) == 1) {
  $asiakas = mysqli_fetch_array($result);
...
if (mysqli_num_rows($result)!=0) {
  ...
  for ($i=0; $i < mysqli_num_fields($result)-2; $i++) {
    echo "<th align='left'><a href='$PHP_SELF?tee=$tee&ppl=$ppl&vvl=$vvl&kkl=$kkl&ppa=$ppa&vva=$vva&kka=$kka&jarj=".mysqli_field_name($result, $i)."'>".t(mysqli_field_name($result, $i))."</a></th>";
  }
