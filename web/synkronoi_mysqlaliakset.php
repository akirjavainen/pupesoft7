...
if (mb_strpos($_SERVER['SCRIPT_NAME'], "synkronoi_mysqlaliakset.php") !== FALSE) {
  require "inc/parametrit.inc";

  echo "<font class='head'>".t("Mysqlaliaksien synkronointi")."</font><hr>";
}

if ($tee == "TEE" or mb_strpos($_SERVER['SCRIPT_NAME'], "iltasiivo.php") !== FALSE) {
  ...
  if (PUPE_UNICODE) {
    ...
    $aliakset = mb_convert_encoding($aliakset, 'UTF-8', mb_list_encodings()); //NO_MB_OVERLOAD
  }
