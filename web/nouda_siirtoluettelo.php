...
if ($_POST["filenimi"] != '' and mb_strpos($_POST["factoringyhtio"], "Nordeasii") !== FALSE) $kaunisnimi = "SOLOMYSA.DAT";
if ($_POST["filenimi"] != '' and mb_strpos($_POST["factoringyhtio"], "OKOsiirto") !== FALSE) $kaunisnimi = "OKOMYSA.DAT";
...
if ($tee == "lataa_tiedosto") {
  ...
  for ($i=0; $i < count($lista); $i++) {
    if (mb_substr($lista[$i], 0, 9) == $factoringyhtio) {
