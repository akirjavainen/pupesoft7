...
if ($tee == 'kateisotto') {
  ...
  if ($voiko_kateisoton_tehda) {
    ...
    $voiko_kateisoton_tehda = validoi_liitetiedosto();
...
function validoi_liitetiedosto() {
  $return = true;
...
function hae_kassalipas($kassalipas_tunnus) {
  ...
  $kassalipas = mysqli_fetch_assoc($result);
...
function hae_kassalippaat() {
  ...
  $kassalippaat = array();
  while ($kassalipas = mysqli_fetch_assoc($result)) {
...
function hae_kateisoton_luonteet() {
  ...
  while ($kateisoton_luonne = mysqli_fetch_assoc($result)) {
