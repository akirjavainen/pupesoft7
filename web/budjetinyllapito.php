...
if (isset($tee) and $tee == "lataa_tiedosto") {
        ...
        foreach ($solut as $u_kausi => $solu) {
          ...
          if ($solu == '!' or (float) $solu != 0) {
            ...
            if (mysqli_num_rows($result) == 1) {
              ...
              $budjrow = mysqli_fetch_assoc($result);
  ...
  if (isset($tkausi)) {
    ...
    if (mysqli_num_rows($vresult) == 1) {
      $tilikaudetrow = mysqli_fetch_assoc($vresult);
    }
  }
  ...
  if (is_array($tilikaudetrow) and count($tasonimi) > 0) {
    ...
    while ($raja < mb_substr($tilikaudetrow['tilikausi_loppu'], 0, 7)) {
      ...
      while ($brow = mysqli_fetch_assoc($xresult)) {
    ...
    foreach ($tasonimi as $key_c => $value) {
      ...
      if (mb_strlen($key) <= $rtaso or $rtaso == "TILI") {
        ...
        if ($rtaso == "TILI") {
          ...
          while ($tilirow = mysqli_fetch_assoc($tiliresult)) {
