...
if ($kausi1!='' and $kausi2!='' and $osasto!='' and $try!='') {
  ...
  $mkausi1  = mb_substr($kausi1, 0, 4)."-".mb_substr($kausi1, 4, 2)."-01";
  $mkausi1l = mb_substr($kausi1l, 0, 4)."-".mb_substr($kausi1l, 4, 2)."-".date("d", mktime(0, 0, 0, mb_substr($kausi1l, 4, 2)+1, 0, mb_substr($kausi1l, 0, 4)));
  $mkausi2  = mb_substr($kausi2, 0, 4)."-".mb_substr($kausi2, 4, 2)."-01";
  $mkausi2l = mb_substr($kausi2l, 0, 4)."-".mb_substr($kausi2l, 4, 2)."-".date("d", mktime(0, 0, 0, mb_substr($kausi2l, 4, 2)+1, 0, mb_substr($kausi2l, 0, 4)));
  ...
  $osastot = mb_substr($osastot, 0, -1);
  $tryt    = mb_substr($tryt, 0, -1);
...
$os_row = mysqli_fetch_array($al_res);
...
$query = "SELECT min(selite+0) minosasto, max(selite+0) maxosasto
          ...
          and laji    = 'TRY'";
$al_res = pupe_query($query);
$try_row = mysqli_fetch_array($al_res);
