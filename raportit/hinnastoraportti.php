...
if ($raptee == "AJA") {
  ...
  if (mysqli_num_rows($productqueryresult) > 2000) {
    echo t("Tuotteita ei näytetä ruudulla, koska niitä on yli")." 2000.";

    require_once 'inc/ProgressBar.class.php';
    $bar = new ProgressBar();
    $elements = mysqli_num_rows($productqueryresult); // total number of elements to process
  ...
  while ($productrow = mysqli_fetch_array($productqueryresult)) {
