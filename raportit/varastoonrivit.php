...
if ($tee != '') {
  ...
  if ($tapa == 'vieja') {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
      ...
      $laskunro_row = mysqli_fetch_assoc($laskunro_res);
    ...
    while ($ressu = mysqli_fetch_assoc($result)) {
      ...
      while ($kayttajittain_row = mysqli_fetch_assoc($kayttajittain_result)) {
        ...
        while ($kayttaja_row = mysqli_fetch_assoc($kayttaja_result)) {
