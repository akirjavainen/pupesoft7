...
if ($tee == 'N') {
  ...
  if (mysqli_num_rows($paaresult) > 0) {

    while ($suoritusrow = mysqli_fetch_assoc($paaresult)) {
  ...
  if (mysqli_num_rows($paaresult) > 0) {
    ...
    while ($suoritusrow = mysqli_fetch_assoc($paaresult)) {
      ...
      if (mysqli_num_rows($result) == 2) {
        ...
        $suoritus1row = mysqli_fetch_assoc($result);
        $suoritus2row = mysqli_fetch_assoc($result);
        ...
        if (mysqli_num_rows($result) == 1) {
          ...
          $tiliointi1row = mysqli_fetch_assoc($result);
          ...
          if (mysqli_num_rows($result) == 1) {
            ...
            $tiliointi2row = mysqli_fetch_assoc($result);
            ...
            $result = pupe_query($query);
            $raha1row = mysqli_fetch_assoc($result);
            ...
            $result = pupe_query($query);
            $raha2row = mysqli_fetch_assoc($result);
