...
class Image_Barcode_ean128 extends Image_Barcode
{
   ...
   *
   */
  function &draw($text = '', $imgtype = 'png', $barwidth = 0, $barcodeheight = 0, $noText = false) {
    ...
    imagestring(
            $img,
            $this->_font,
            $barcodewidth / 2 - mb_strlen($text) / 2 * (imagefontwidth($this->_font)),
  ...
  public function __construct() {
    ...
    public function Image_Barcode_ean128() {
         self::__construct();
    }
