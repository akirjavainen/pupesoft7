...
if ($tee == 'erittelykopsu') {
  ...
  if (mysqli_num_rows($lahtores) > 0) {

    $lahtorow = mysqli_fetch_assoc($lahtores);
...
if ($tee == 'valitse' and $real_submit != '') {
  ...
  if ($otunnus == "") {
    ...
    if (isset($lahto) and trim($lahto) != "" and $yhtiorow['kerayserat'] == 'K') {
      ...
      $lahdot_lasku_chk_row = mysqli_fetch_assoc($lahdot_lasku_chk_res);
    ...
    $rahtikirjanro = mysqli_fetch_array($res);
