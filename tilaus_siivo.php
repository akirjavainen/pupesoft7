...
if (mysqli_num_rows($res) > 0) {
  echo "<tr><td colspan='8' class='back'>Keskenolevat tilaukset joilla on rivejä (".mysqli_num_rows($res)."kpl):</td></tr>";

  $edgrouppi = "";
  $lask     = 1;

  while ($laskurow = mysqli_fetch_array($res)) {
...
if (mysqli_num_rows($res) > 0) {
  echo "<tr><td colspan='8' class='back'>Rivittömät otsikot (".mysqli_num_rows($res)."kpl):</tr>";
  echo "<tr><th>Tunnus:</th><th>Tila:</th><th>Alatila:</th><th>Nimi:</th><th>Vienti:</th><th>Valuutta:</th><th>Kassa/Extranet:</th><th>Luontiaika:</th><th>Mitätöi:</th></tr>";
...
if (mysqli_num_rows($res) > 0) {
  echo "<tr><td colspan='8' class='back'>Odottaa JT-tuotteita, mutta tilauksella ei JT rivejä (".mysqli_num_rows($res)."kpl):</tr>";
