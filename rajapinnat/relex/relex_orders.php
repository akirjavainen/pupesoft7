...
echo date("d.m.Y @ G:i:s") . ": Relex tilausrivejä {$rows} kappaletta.\n";
...
while ($row = mysqli_fetch_assoc($res)) {
  ...
  if ($row['tyyppi'] == "G") {
    // Siirtorivit laitetaan failiin avoimena myyntinä lähdevarastosta ja avoimena ostona kohdevarastoon.
    // Kun siirtorivi on kerätty, niin se ei enää näy avoimena myyntinä, pelkästään ostona kohdevarastoon.
    if ($row['keratty'] == "") {
