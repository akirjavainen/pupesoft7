...
$konsernit = " and yhtio in (".mb_substr($konsernit, 0, -1).") ";
...
if ($toim != "") {
  if ($kentta03 != '') {
    ...
    $tulos = mail("$yhtiorow[varauskalenteri_email]", mb_encode_mimeheader($toim, "UTF-8", "Q"), $meili, "From: ".mb_encode_mimeheader($kukarow["nimi"], "UTF-8", "Q")." <".$kukarow["eposti"].">\nReply-To: ".mb_encode_mimeheader($kukarow["nimi"], "UTF-8", "Q")." <".$row["eposti"].">\n", "-f $yhtiorow[postittaja_email]");
  }
  else {
