...
if (isset($tee) and ($tee == "GENEROI" or $tee == "NAYTATILAUS") and $laskunumerot != '') {
  ...
  if (!isset($tee) or $tee != "NAYTATILAUS") {
    ...
    echo "<font class='message'>".t("Aineistoon lisätään")." ".mysqli_num_rows($res)." ".t("laskua").".</font><br><br>";
  }

  while ($lasrow = mysqli_fetch_assoc($res)) {
...
function hae_tilausnumero($laskunro) {
  ...
  $tilausnumerot = mysqli_fetch_assoc($tilausnumerot);
