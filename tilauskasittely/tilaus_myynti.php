...
// MUOKKAUS: isset():
foreach (array("ale_peruste", "perusta_tilaustyyppi", "projekti", "jarjlisa", "yt", "postitp", "kantaasiakastunnus", "ytunnus", "kateinen", "projektilask", "rivitunnus", "kohderivitunnus", "kplmaara", "myyjanro", "yllapidossa", "toimitusaikaikkuna") as $v) {
  if (!isset(${$v})) ${$v} = null;
}
...
if ($tee == '') {
  ...
  if ($tila == 'MUUTA' and (int) $kukarow["kesken"] > 0) {
	...
	// MUOKKAUS: isset():
        ...
        $alv = $tilausrivi['alv'];
	$rivin_tallennettu_alv = $tilausrivi['alv']; // MUOKKAUS: Lisätty, jotta tallennettu ALV säilyy rivimuokkauksessa
