...
if ($tee == 'etsi_sscc' and $sscc != "") {
  ...
  if (mysqli_num_rows($suuntalava_res) > 0) {
    ...
    while ($suuntalava_row = mysqli_fetch_assoc($suuntalava_res)) {
...
if ($tee == 'etsi_saapuminen' and $saapuminen != "") {
  ...
  if (mysqli_num_rows($res) > 0) {
    ...
    while ($suuntalava_row = mysqli_fetch_assoc($res)) {
